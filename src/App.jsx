...
function App() {
  const [lang, setLang] = React.useState(
    JSON.parse(window.localStorage.getItem("lg")) || "en"
  );
            ...
            <select
              onChange={(evt) => {
                ...
                window.localStorage.setItem(
                  "lg",
                  JSON.stringify(evt.target.value)
                );
              }}
              value={lang}
              className="select"
            ...
            <ul className="nav-list">
              ...
              <li className="nav-item">
                <a href="index.html" className="icon-link">
                  ...
                  <h4 className={`nav-text ${theme}`}>
                    {content[lang].colocol}
                  </h4>
                </a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a href="index.html" className="icon-link">
                  <img
                    src={ZakladkaIcon}
                    alt="logo"
                    className="zakladka-icon"
                  />
                  <h4 className={`nav-text ${theme}`}>
                    {content[lang].zakladka}
                  </h4>
                </a>
              </li>
              <li className="nav-item">
          ...
          <div className={`div-central ${theme}`}>
            ...
            <form className={`central-form ${theme}`}>
              <img
                src={ProfileBro}
                alt="profilelogo"
                className="central-input-profile"
              />
              ...
              <input
                ...
                type="text"
                name="input-post"
                placeholder={content[lang].inputone}
                className={`central-input ${theme}`}
              />
            ...
            <ul className="central-list">
              <li className="central-item">
                ...
                <div className="popularnosti">
                  <span className="comments">
                    ...
                    <p className="comments-number">10</p>
                  </span>
              ...
              <li className="central-item">
                ...
                <p className="central_users-text ">
                  ...
                  Mentorlik davomida talaba va <br /> yangi bitiruvchilarni
                ...
                <div className="popularnosti">
                  <span className="comments">
                    <img src={Comments} alt="icon" className="comments-icon" />
                    <p className="comments-number"></p>
                  </span>

                  <span className="st">
                    <img src={StrelkaGreen} alt="icon" className="st-icon" />
                    <p className="st-number-green green">5</p>
                  </span>

                  <span className="like">
                    <img src={LikeRed} alt="icon" className="like-icon" />
                    <p className="like-number-red red">9</p>
                  </span>
          ...
          <div className="end-div">
            <div className="div-input-search">
              <input
                ...
                type="text"
                name="search-imput"
                placeholder={content[lang].inputtwo}
            ...
            <ul className="end-list">
              ...
              <li className="end-item">
                ...
                <h3 className="end-item_header">
                  {content[lang].trends_revolution}
                </h3>
                <span className="end-item_span">
                  {content[lang].revolution_tweet}
                </span>
              ...
              <li className="end-item">
                <button className="end-button">{content[lang].showbtn}</button>
              </li>
            </ul>
            ...
            <ul className="footer-list">
              ...
              <li className="footer-item">
                <a href="profile.html"> {content[lang].footer_privacy}</a>
              </li>
